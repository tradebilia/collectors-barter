...
| SGC via Parse.bot | Certification identity, grade, designation, population, and higher population | First published check passed with `5445321`: 1980 Topps #482 Rickey Henderson, grade 6, EX/NM, population 1,905, higher 7,065. One immediate later repeat reported temporary unavailability, so availability is presently considered intermittent until a bounded retry succeeds. |
...
- **Collectr:** Product search/detail/bulk lookup, current market value, grade-specific pricing, and price history. Potential next card-market test after existing source stability is established. Source: https://parse.bot/marketplace/e9b4ef46-2252-4f98-829e-b4dc96816aa8/app-getcollectr-com-api
