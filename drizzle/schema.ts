...
export const tradePayments = mysqlTable("tradePayments", {
	...
	paypalEmail: varchar({ length: 320 }).notNull(),
	transactionId: varchar({ length: 255 }),
	status: mysqlEnum(['pending','submitted','verified','failed']).default('pending').notNull(),
