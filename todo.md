...
- [ ] Increase the visible Recently Added carousel item size in the combined bar-refinement pass while retaining compact spacing and readable responsive behavior; validate and synchronize the change.
