...
- [ ] Complete the approved Membership migration against the actual custom TiDB runtime database after schema tooling was confirmed to target the separate managed project database; do not alter marketplace data or switch database sources.
