...
- [x] Replace listing-detail Message Owner and Trade Proposal action labels with sign-in entry actions for visitors arriving from public profile collections, while keeping authenticated-member actions unchanged. Visitors now see Sign in to trade and Sign in to message; both handlers enter the sign-in flow and the message modal cannot mount without authentication. Focused access-control tests, TypeScript, and production build passed.
