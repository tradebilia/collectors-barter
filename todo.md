...
- [ ] MEDIA MANIFEST EVIDENCE: Produce a complete checksum-backed manifest and recovery procedure for all static assets plus all 25 listing-photo and 4 avatar records, including verified destination accessibility from an independent project context.
