...
- [ ] Conduct a second, deeper read-only whole-code audit after the P0–P2 remediation, covering source, custom-TiDB contracts, authorization, payment and external-provider boundaries, scheduled work, storage, tests, runtime behavior, regression risks, and the final deployment/synchronization state; reproduce findings before requesting approval for any fixes.
