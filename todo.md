...
- [ ] Future implementation decision: if approved, build Whatnot Reference as a member-controlled, source-labeled trust card using aggregate reputation only—rating, review count, sold count, follower count, average shipping time, seller status, source link, and refresh date—with no individual review text, reviewer identities, marketplace inventory, or pricing import.
