...
- [ ] Resolve the 21 unrelated pre-existing or environment-dependent failures in the full Vitest suite; the latest run passed 702 tests, while the remaining failures are concentrated in stale UI/source assertions and provider/network-dependent checks. The Music, LEGO, and Submit Collectible changes are not implicated.
