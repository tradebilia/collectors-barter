...
describe("Coming Soon experience", () => {
  it("uses the animated Tradebilia logo and has an opt-in email form", () => {
    ...
    expect(pageSource).toContain('className="mx-auto h-20 w-full max-w-[34rem] translate-y-12 overflow-hidden px-2 sm:h-28 sm:max-w-[42rem] sm:translate-y-20 sm:px-4"');
