...
describe("legacy trade timeline fallback", () => {
  it("reconstructs historical milestones and messages in chronological order without an activity-log table", () => {
    const events = buildLegacyTradeTimeline({ id: 120003, requesterId: 30002, requesterName: "Administrator", recipientName: "Rtavani", listingTitle: "McFarlane King Spawn Original Art", status: "shipping", createdAt: "2026-08-01 09:00:00", negotiatingAt: "2026-08-02 09:00:00", acceptedAt: "2026-08-03 09:00:00", shippingAt: "2026-08-04 09:00:00", initiatorMessage: "Interested in your card" }, [{ id: 7, senderId: 60003, actorName: "Rtavani", message: "How about this?", createdAt: "2026-08-02 12:00:00" }]);
    ...
    expect(events[0]).toMatchObject({ actorName: "Administrator", details: "Trade proposal initiated for item: McFarlane King Spawn Original Art" });
