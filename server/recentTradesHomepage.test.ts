...
describe("homepage Recent Trades carousel", () => {
  it("uses the ten newest completed trades and preserves complete exchanged-item data", async () => {
    ...
    expect(carouselSource).toContain("w-full min-w-0 items-center justify-center gap-3 text-center");
    ...
    expect(carouselSource).toContain("justify-center gap-3 text-center");
