...
describe("Coming Soon logo containment", () => {
  it("expands the SVG lockup frame for the enlarged wheel and long category labels", () => {
    expect(source).toContain('<div className="mx-auto flex aspect-[20/4] min-h-32 w-full max-w-full translate-y-12 items-center overflow-hidden sm:-mx-12 sm:aspect-[20/4] sm:min-h-32 sm:w-[calc(100%+12rem)] sm:max-w-[54rem] sm:translate-y-20 sm:overflow-visible sm:px-4">');
