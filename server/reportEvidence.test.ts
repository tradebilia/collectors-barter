...
describe("report evidence metadata", () => {
  it("preserves report context and server-owned attachment references", () => {
    const stored = serializeReportEvidence({ notes: "Package arrived with damage.", listingReference: "TR-000001", contactEmail: "collector@example.com", attachments: [{ key: "reports/30002/receipt.png", url: "/manus-storage/reports/30002/receipt.png", name: "receipt.png", type: "image/png", size: 1024 }] });
