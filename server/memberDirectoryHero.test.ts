...
describe("Member Directory hero integration", () => {
  it("uses the shared top bar, homepage hero background, supplied title artwork, and category bar", () => {
    ...
    expect(source).toContain('backgroundImage: "url(/manus-storage/Background_23084d14.jpg)"');
    expect(source).toContain('src="/manus-storage/MemberDirectory_de7393cf.webp"');
