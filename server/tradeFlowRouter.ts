...
Respond with ONLY this JSON object — no markdown, no code blocks, just raw JSON:
{
  ...
  "myItemFuturePotential": <OBJECT (not string). Keys are exact item names from YOUR SIDE. Values are 2-3 sentence projections. Give REALISTIC bear/base/bull price scenarios with dollar ranges. Name single biggest catalyst. Give investment rating X/10.>,
  ...
  "theirItemFuturePotential": <OBJECT (not string). Keys are exact item names from THEIR SIDE. Values are 2-3 sentence projections (no label needed). Same format as myItemFuturePotential.>,
