...
After deployment propagation, the standard public Create Account page was verified to display **Email** as required rather than optional. The standard public Account Setup route was also verified to show the protected **Create Account to Continue** entry rather than a second account-creation form. No test account or production record was created during this release verification.
