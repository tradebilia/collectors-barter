...
export const SPORTS_CARDS_SET_FIELDS: FieldDefinition[] = [
  ...
  },
  {
    ...
    inputType: 'dropdown',
    requirement: 'required',
    dropdownOptions: ['Topps', 'Bowman', 'Panini', 'Upper Deck', 'Fleer', 'Donruss', 'Score', 'Leaf', 'O-Pee-Chee', 'Other'],
    supportsOther: true,
...
export const VIDEO_GAMES_ACCESSORY_FIELDS: FieldDefinition[] = [
  ...
  },
  {
    ...
    inputType: 'dropdown',
    requirement: 'required',
    dropdownOptions: ['CGC Home Video', 'CGC Video Games', 'IGS', 'PSA', 'VGA', 'WATA', 'Other'],
    supportsOther: true,
    inlineCustomField: true,
    otherFieldName: 'Custom Grading Company',
    conditionalLogic: 'Is Graded = yes',
