...
export const COINS_SINGLE_COIN_FIELDS: FieldDefinition[] = [
  ...
  },
  {
    ...
    inputType: 'dropdown',
    requirement: 'required',
    dropdownOptions: ['ANACS', 'ICG', 'NGC', 'PCGS', 'SEGS', 'SGS', 'Other'],
    supportsOther: true,
...
export const COINS_PAPER_MONEY_BANKNOTES_FIELDS: FieldDefinition[] = [
  ...
  },
  {
    ...
    inputType: 'dropdown',
    requirement: 'required',
    dropdownOptions: ['ANACS', 'ICG', 'PCGS', 'PMG', 'Other'],
    supportsOther: true,
    inlineCustomField: true,
    otherFieldName: 'Custom Grading Company',
    conditionalLogic: 'Is Graded = Yes',
...
export const POKEMON_SINGLE_CARD_FIELDS: FieldDefinition[] = [
  ...
  },
  {
    ...
    supportsOther: true,
    otherFieldName: 'customEditionEra',
  },
  {
    name: 'finishVariant',
