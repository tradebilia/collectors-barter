...
export const COMICS_SINGLE_COMIC_FIELDS: FieldDefinition[] = [
  ...
  },
  {
    ...
    inputType: 'dropdown',
    requirement: 'required',
    dropdownOptions: ['CGC Comics', 'CBCS', 'PGX Comics', 'Other'],
    supportsOther: true,
    inlineCustomField: true,
    otherFieldName: 'Custom Grading Company',
    conditionalLogic: 'Is Graded = Yes',
...
export const MOVIES_INDIVIDUAL_MOVIE_FIELDS: FieldDefinition[] = [
  ...
  },
  {
    ...
    inputType: 'dropdown',
    requirement: 'required',
    dropdownOptions: ['CGC Home Video', 'VHS Grading', 'IGS', 'Other'],
    supportsOther: true,
    inlineCustomField: true,
    otherFieldName: 'Custom Grading Company',
    conditionalLogic: 'Is Graded = Yes',
...
export const STAMPS_SINGLE_STAMP_FIELDS: FieldDefinition[] = [
  ...
  },
  {
    ...
    inputType: 'dropdown',
    requirement: 'required',
    dropdownOptions: ['PSE', 'ASG', 'PSAG', 'Other'],
    supportsOther: true,
    inlineCustomField: true,
    otherFieldName: 'Custom Grading Company',
    conditionalLogic: 'Is Graded = yes',
...
export const VIDEO_GAMES_ACCESSORY_FIELDS: FieldDefinition[] = [
  ...
  },
  {
    ...
    inputType: 'dropdown',
    requirement: 'required',
    dropdownOptions: ['WATA', 'CGC Video Games', 'VGA', 'CGC Home Video', 'IGS', 'Other'],
    supportsOther: true,
    inlineCustomField: true,
    otherFieldName: 'Custom Grading Company',
    conditionalLogic: 'Is Graded = Yes',
...
export const VIDEO_GAMES_CONSOLE_FIELDS: FieldDefinition[] = [
  ...
  },
  {
    ...
    inputType: 'dropdown',
    requirement: 'required',
    dropdownOptions: ['WATA Games (PSA Video Games)', 'CGC Video Games', 'VGA', 'CGC Home Video', 'IGS', 'Other'],
    supportsOther: true,
    inlineCustomField: true,
    otherFieldName: 'Custom Grading Company',
...
export const POKEMON_SINGLE_CARD_FIELDS: FieldDefinition[] = [
  ...
  },
  {
    ...
    inputType: 'dropdown',
    requirement: 'conditional',
    dropdownOptions: ['PSA', 'BGS', 'SGC', 'CGC Cards', 'TAG Grading', 'HGA', 'Arena Club', 'Degree', 'ACE', 'ISA', 'GMA', 'Rare Edition', 'FCG', 'MNT', 'KSA', 'PGA', 'RCG', 'OnlyGraded', 'Diamond', 'CGA', 'TRCG', 'Pokegrade', 'Tree Frog', 'AP', 'PRO', 'GEM', 'GAI', 'PCI', 'WCG', 'Other'],
    conditionalLogic: 'Is Graded = Yes',
    supportsOther: true,
    inlineCustomField: true,
    otherFieldName: 'Custom Grading Company',
