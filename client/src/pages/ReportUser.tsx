...
export default function ReportUser() {
  ...
  return <div className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(73,125,255,0.14),transparent_30%),linear-gradient(180deg,#050814_0%,#0b1220_32%,#111827_100%)] text-white"><TopBar hideSearch /><section className="relative z-0 w-screen -mx-[calc((100vw-100%)/2)] overflow-hidden border-b border-white/10 bg-[#00143A] text-white"><div className="absolute inset-0" style={{ backgroundImage: `url(${REPORT_USER_HERO_BACKGROUND_URL})`, backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }} /><div className="container relative flex h-64 items-center justify-center py-0 sm:h-72 lg:h-80"><div className="relative aspect-[2048/707] w-full max-w-7xl"><img src={REPORT_USER_HERO_TITLE_URL} alt="Report a Member" className="absolute inset-0 h-full w-full object-contain" style={{ WebkitMaskImage: "linear-gradient(to right, transparent 0 30%, #000 30% 100%)", maskImage: "linear-gradient(to right, transparent 0 30%, #000 30% 100%)" }} /><div aria-hidden="true" className="absolute left-[19%] top-1/2 flex h-[40%] -translate-y-1/2 items-center justify-center"><TradebiliaWheel className="tradebilia-wheel-home h-full w-auto drop-shadow-2xl" /></div></div></div></section><CategoryBar /><main className="container py-8"><div className="mx-auto max-w-3xl"><Card className="border-white/10 bg-white/5 backdrop-blur"><CardHeader className="border-b border-white/10"><CardTitle className="flex items-center gap-2 text-white"><Flag className="h-5 w-5 text-red-400" />Report a Member</CardTitle><CardDescription className="text-white/60">Report a community safety concern. For a trade-specific item or shipment issue, use the Trade Room link so the case includes the correct trade context.</CardDescription></CardHeader><CardContent className="pt-6">
