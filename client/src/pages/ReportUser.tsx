...
export default function ReportUser() {
  ...
  useEffect(() => {
    if (!contactEmailEdited && user?.email) setContactEmail(user.email);
  }, [contactEmailEdited, user?.email]);
