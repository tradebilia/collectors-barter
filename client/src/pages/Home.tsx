        ...
        <Dialog open={showPreview} onOpenChange={setShowPreview}>
          ...
          <DialogContent className="max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                {item.grade ? `${getDisplayedGradingCompany(item.certificationCompany, item.customGradingCompany)} ${formatGrade(item.grade)}` : 'Ungraded'}
              </DialogDescription>
            </DialogHeader>
...
export default function Home() {
  ...
  const recentShelfItems = (marketplaceQuery.data?.listings ?? []).length
    ? (marketplaceQuery.data?.listings ?? []).slice(0, 15).map(listing => ({
        ...
        customGradingCompany: listing.customGradingCompany,
        grade: listing.grade,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center justify-center gap-3 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-1">
              <Link href="/how-it-works" className="text-sm text-white hover:text-white/80 transition-colors">
          ...
          <div className="mt-3 border-t border-white/10 pt-3 text-center">
            <p className="mx-auto max-w-2xl text-[10px] uppercase leading-relaxed tracking-widest text-white/90">
