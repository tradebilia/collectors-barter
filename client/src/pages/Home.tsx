          ...
          <div className="grid gap-0 grid-cols-2 sm:grid-cols-5 items-center">
            {[
              ...
              const iconMap: Record<string, React.ReactNode> = {
                ...
                handshake: <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3v-6" /></svg>,
