...
export default function WarRoom() {
  ...
  // ── Render ────────────────────────────────────────────────────────────────
  return (
    <div className={`trade-room-shell flex min-h-[100dvh] flex-col overflow-x-hidden bg-[#0f0f1a] ${currentStage === 'accepted' ? 'trade-room-finalize-whole' : currentStage === 'shipping' ? 'trade-room-shipping-whole' : currentStage === 'shipped' ? 'trade-room-confirm-whole' : currentStage === 'review' ? 'trade-room-review-whole' : currentStage === 'completed' ? 'trade-room-complete-whole' : ''}`}>
                ...
                {currentStage !== 'shipping' && <div className="bg-[#16213e] border border-gray-600 rounded-xl p-5 shadow-xl">
                  ...
                  <div className="flex flex-col gap-6 lg:flex-row lg:items-stretch">
                    ...
                    <div className="flex shrink-0 items-center justify-center lg:self-stretch">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.75} stroke="currentColor" className="trade-room-exchange-arrow my-auto h-12 w-12 text-cyan-300 drop-shadow-[0_0_8px_rgba(34,211,238,0.45)]">
                        ...
                        {contact ? (
                          <div className="space-y-3 text-base">
                            ...
                            <div className="flex items-start gap-2">
                              ...
                              <p className="text-gray-200 text-base">{contact.contactPhone ? formatTradeRoomPhone(contact.contactPhone) : <span className="text-gray-600 italic">Phone not provided</span>}</p>
                            </div>
                          </div>
                        ) : (
