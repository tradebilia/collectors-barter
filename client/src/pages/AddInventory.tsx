  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,#1c2468_0%,#0b0a22_65%)] text-white">
      ...
      <div className="container mx-auto max-w-7xl px-4 py-12 relative">
        ...
        {/* The panel stays at its established desktop position and returns to normal flow on phones. */}
        <div className="mt-8 w-full lg:absolute lg:top-12 lg:-right-4 lg:z-10 lg:w-80">
            <div className="rounded-lg border border-white/20 bg-white/5 p-4 backdrop-blur sm:p-6">
