    ...
    <div className={`min-h-screen ${theme.pageClassName}`}>
      ...
      <header className={`relative overflow-hidden border-b ${theme.borderClassName} ${theme.heroClassName}`} style={{ minHeight: '400px' }}>
        <div className={`relative overflow-hidden ${theme.textureClassName}`} style={{
          backgroundImage: isSportsCardsPage ? 'url(/images/Sportscardwallpaper.webp)' : slug === 'video_games' ? 'url(/images/video-games-bg.webp)' : slug === 'coins' ? 'url(/images/CoinsBackground.png)' : slug === 'stamps' ? 'url(/images/StampsBackground.png)' : slug === 'vintage_toys' ? 'url(/images/VintageToysBackground.png)' : slug === 'autographs' ? 'url(/images/AutoBackground.png)' : slug === 'movies' ? 'url(/images/VHSBackground.png)' : slug === 'comics' ? 'url(/images/comics-bg.webp)' : slug === 'pokemon' ? 'url(/images/pokemon-bg.webp)' : slug === 'disney_pins' ? 'url(/images/disney-pins-bg.webp)' : undefined,
