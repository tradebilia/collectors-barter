...
export default function CategoryPage() {
  ...
  const SPORTS_CARDS_LONG_LOGO_URL = "/images/tradebilia-logo_c676d640.svg";
    ...
    <div className={`min-h-screen ${theme.pageClassName}`}>
      ...
      <header className={`relative overflow-hidden border-b ${theme.borderClassName} ${theme.heroClassName}`} style={{ minHeight: '400px' }}>
        <div className={`relative overflow-hidden ${theme.textureClassName}`} style={{
          backgroundImage: isSportsCardsPage ? 'url(/images/Sportscardwallpaper_bc1c7d7a.webp)' : slug === 'video_games' ? 'url(/images/video-games-background-kyx4vVUqTYCMC3kMbtokYU_c9f7dffa.webp)' : slug === 'coins' ? 'url(/images/CoinsBackground_ef9aac41.png)' : slug === 'stamps' ? 'url(/images/StampsBackground_381d3e98.png)' : slug === 'vintage_toys' ? 'url(/images/VintageToysBackground_8ab6860f.png)' : slug === 'autographs' ? 'url(/images/AutoBackground_d025a571.png)' : slug === 'movies' ? 'url(/images/VHSBackground_99756671.png)' : slug === 'comics' ? 'url(/images/comics-background-YZiiH2cyV8YJx6GFQj4PKC_2cc313bb.webp)' : slug === 'pokemon' ? 'url(/images/pokemon-background-J6h7Mte6BSYA3GfQ4vtdFj_d1df88b6.webp)' : slug === 'disney_pins' ? 'url(/images/disney-pins-background-F6yUvFLVrhmnaWk6GsFMZ8_172dee25.webp)' : undefined,
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="mt-3 leading-none" style={{ marginTop: "24px" }}>
                <h1 className="max-w-full mx-auto text-6xl sm:text-7xl lg:text-8xl" style={{
                  ...
                  {slug === "disney_pins" ? (
                    <img src="/images/DisneyPinsTitle_dc12f61b.png" alt="Disney Pins" style={{ maxHeight: "475px", width: "auto", objectFit: "contain", marginBottom: "30px", marginTop: "130px" }} />
                  ) : slug === "pokemon" ? (
                    <img src="/images/PokemonTitle_eaf0db72.png" alt="Pokemon" style={{ maxHeight: "380px", maxWidth: "90%", width: "auto", objectFit: "contain", marginBottom: "30px", transform: "translateY(15px)" }} />
                  ) : slug === "comics" ? (
                    <img src="/images/ComicsTitle_b915b61d.png" alt="Comics" style={{ maxHeight: "300px", width: "auto", objectFit: "contain", marginBottom: "-40px" }} />
                  ) : slug === "sports_cards" ? (
                    <img src="/images/SportsCardsTitle_db2535b2.png" alt="Sports Cards" style={{ maxHeight: "300px", width: "auto", objectFit: "contain", marginBottom: "30px", transform: "translateY(-100px)", marginLeft: "-15px" }} />
                  ) : slug === "vintage_toys" ? (
                    <img src="/images/VintageToysTitle_11b8cdd9.png" alt="Vintage Toys" style={{ maxHeight: "550px", width: "auto", objectFit: "contain", marginBottom: "30px", transform: "translateY(-200px)" }} />
                  ) : slug === "coins" ? (
                    <img src="/images/CoinsTitle_40d49d1d.webp" alt="Coins" style={{ maxHeight: "225px", width: "auto", objectFit: "contain", marginBottom: "30px", transform: "translateY(-75px)", marginLeft: "-15px" }} />
                  ) : slug === "stamps" ? (
                    <img src="/images/StampsTitle_cc0e76c3.webp" alt="Stamps" style={{ maxHeight: "200px", width: "auto", objectFit: "contain", marginBottom: "30px", transform: "translateY(10px)" }} />
                  ) : slug === "video_games" ? (
                    <img src="/images/VideoGamesTitle_e5b075b7.webp" alt="Video Games" style={{ maxHeight: "550px", width: "auto", objectFit: "contain", marginBottom: "30px", transform: "translateY(-200px)" }} />
                  ) : slug === "movies" ? (
                    <img src="/images/Movies4_fa883aec.png" alt="Movies" style={{ maxHeight: "250px", width: "auto", objectFit: "contain", marginBottom: "30px", transform: "translateY(-95px)" }} />
                  ) : slug === "autographs" ? (
                    <img src="/images/AutographsTitle_85ad05d3.png" alt="Autographs" style={{ maxHeight: "300px", width: "auto", objectFit: "contain", marginBottom: "30px", transform: "translateY(-100px)", marginLeft: "-25px" }} />
