            ...
            <div className="container relative py-12 lg:py-16 z-10">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="mt-3 leading-none">
                  <h1 className="max-w-5xl mx-auto text-6xl sm:text-8xl lg:text-[7rem]" style={{ fontFamily: "'Righteous', sans-serif", letterSpacing: "0.05em", fontStyle: "italic", fontWeight: 700, color: "#F5F1E8", textShadow: "2px 2px 4px rgba(0,0,0,0.5)", WebkitTextStroke: "0.5px rgba(255,255,255,0.6)" }}>
