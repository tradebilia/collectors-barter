    ...
    <div className={`min-h-screen ${theme.pageClassName}`}>
      ...
      <header className={`relative overflow-hidden border-b ${theme.borderClassName} ${theme.heroClassName}`} style={{ minHeight: '400px' }}>
        <div className={`relative overflow-hidden ${theme.textureClassName}`} style={{
          backgroundImage: isSportsCardsPage ? 'url(/manus-storage/sportscards2_50e2e734.png)' : slug === 'video_games' ? 'url(/manus-storage/VideoGames_dd67123d.png)' : slug === 'coins' ? 'url(/manus-storage/Coins_353ff538.png)' : slug === 'stamps' ? 'url(/manus-storage/Stamps1_9eaf705a.png)' : slug === 'vintage_toys' ? 'url(/manus-storage/Vintagetoys2_b56d7fdc.png)' : slug === 'autographs' ? 'url(/manus-storage/Autographs_5775ffb1.png)' : slug === 'movies' ? 'url(/manus-storage/Movies2_d17cc5ad.png)' : slug === 'comics' ? 'url(/manus-storage/Comicpage2_6d086599.png)' : slug === 'pokemon' ? 'url(/manus-storage/Pokemon_095946ab.png)' : slug === 'disney_pins' ? 'url(/manus-storage/Disney_e4ae94b5.png)' : undefined,
