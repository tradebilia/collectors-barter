                ...
                <div className="mt-5 pt-5 border-t border-gray-100">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <a
                      ...
                      className="flex items-center gap-2 px-3 py-2 rounded-full bg-[#1877F2] text-white text-xs font-semibold hover:bg-[#166fe5] transition"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-3 py-2 rounded-full bg-black text-white text-xs font-semibold hover:bg-gray-800 transition"
                      title="Share on X"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-3 py-2 rounded-full bg-[#E60023] text-white text-xs font-semibold hover:bg-[#cc001f] transition"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-3 py-2 rounded-full bg-[#FF4500] text-white text-xs font-semibold hover:bg-[#e03d00] transition"
                    ...
                    <a
                      ...
                      className="flex items-center gap-2 px-3 py-2 rounded-full bg-gray-600 text-white text-xs font-semibold hover:bg-gray-700 transition"
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-3 py-2 rounded-full bg-gray-100 text-gray-700 text-xs font-semibold hover:bg-gray-200 transition"
                      title="Copy link"
                    >
