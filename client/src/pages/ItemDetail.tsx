    ...
    <div className={`min-h-screen ${pageBackgroundClass}`}>
      ...
      <main className="pb-16">
       <section className="relative z-0 w-screen -mx-[calc((100vw-100%)/2)] overflow-hidden text-white" style={{
          backgroundImage: getCategoryWallpaperUrl(listing.category) ? `url(${getCategoryWallpaperUrl(listing.category)})` : 'url(/manus-storage/Background_48b923f1.jpg)',
        ...
        <div className="container relative flex h-64 items-center justify-center py-0 sm:h-72 sm:py-0 lg:h-80 lg:py-0">
            ...
            <div className="relative z-10 flex w-full max-w-6xl items-center justify-center -ml-32">
              <img
