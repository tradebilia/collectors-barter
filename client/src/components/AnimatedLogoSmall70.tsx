...
const AnimatedLogoSmall70 = ({ compact = false }: AnimatedLogoSmall70Props) => {
  ...
  return (
    <div className="flex h-full items-center justify-center font-sans py-0" aria-label={`Trade ${currentCategory.name}`}>
      <svg
        ...
        viewBox={compact ? "0 54 126 138" : "0 0 1300 216"}
      ...
      >
        ...
        <g transform="translate(6, 82.5) scale(0.441)" filter="url(#wheelGlowSmall)">
        ...
        {!compact && <line x1="114" y1="81.3" x2="114" y2="178.5" stroke="white" strokeWidth="2.55" strokeLinecap="round" />}
        {!compact && <text x="132" y="157.5" fontFamily="Montserrat, sans-serif" fontSize="60" fontWeight="600" fill="white">TRADE</text>}
        {!compact && <text x="348" y="157.5" fontFamily="Montserrat, sans-serif" fontSize="60" fontWeight="600" fill={currentCategory.color}>{currentCategory.name}</text>}
      </svg>
    </div>
  );
};
