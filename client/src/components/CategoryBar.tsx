  ...
  return (
    <nav className="relative z-10 border-b border-white/10 bg-black">
      <div className="flex w-full overflow-x-auto">
        <Link
          href="/"
          className={`flex-1 border-r border-white/10 px-4 py-4 text-center text-xs font-semibold uppercase tracking-[0.16em] transition hover:bg-white/10 lg:text-[11px] whitespace-nowrap ${
